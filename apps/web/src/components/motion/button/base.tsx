...
const SIZE_CLASS: Record<ButtonSize, string> = {
  sm: "h-8 px-3 text-xs gap-1.5 rounded-xl [@media(pointer:coarse)]:h-11",
  md: "h-10 px-5 text-sm gap-2 rounded-xl [@media(pointer:coarse)]:h-11",
  lg: "h-12 px-6 text-base gap-2 rounded-full",
  icon: "h-8 w-8 rounded-lg [@media(pointer:coarse)]:h-11 [@media(pointer:coarse)]:w-11",
};

const FOCUS_CLASS =
  "outline-none focus-visible:ring-2 focus-visible:ring-foreground/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background";

    ...
    <>
      ...
      <thead>
        <tr style={{ height: rowHeight }}>
          {selectable ? (
            <th className="sticky top-0 z-20 border-border border-b bg-muted">
          ...
          {columns.map((column, index) => {
            ...
            return (
              <th
                ...
                className={cn(
                  "group sticky top-0 z-20 border-border border-b bg-muted p-0 font-medium text-muted-foreground",
                ...
                >
                  ...
                  {column.sortable ? (
                    ...
                    <input
                      ...
                      className={cn(
                        "min-w-0 flex-1 truncate appearance-none rounded-md border-0 bg-transparent px-4 font-medium text-muted-foreground outline-none transition-colors focus:bg-muted focus:text-foreground focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring",
          ...
          <th aria-hidden className="sticky top-0 z-20 border-border border-b bg-muted" />
        </tr>
      </thead>
    </>
  );

...
The measured 60.179-second soak ran continuous CONNECT traffic concurrently with three full
...
285 reads against the daemon's own WAL-mode SQLite database while imports wrote revisions. Three
daemon crash-recovery callbacks exercised the Mihomo restart boundary. It attempted 9,120 CONNECTs;
480 returned HTTP 502, for a measured success rate of 94.7368%.
